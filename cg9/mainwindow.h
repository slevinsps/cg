...
public:
    ...
    bool check_visiable_point(point_str p0, point_str p1, point_str p2);
    bool check_intersection(point_str s1, point_str s2, point_str p1, point_str p2);
    point_str find_intersection(point_str s1, point_str s2, point_str p1, point_str p2);
signals:
